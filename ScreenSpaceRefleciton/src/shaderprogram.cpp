...
void ShaderProgram::createAndCompileShaderProgram(QString vertFile,
    ...
    QString vertShadertextPath = projectPath + vertFile;
    QString fragShadertextPath = projectPath + fragFile;
    ...
    char *vertexShaderSource = textFileRead(vertShadertextPath.toStdString().c_str());
    char *fragmentShaderSource = textFileRead(fragShadertextPath.toStdString().c_str());
